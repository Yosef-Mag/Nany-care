...
const reviewSchema = yup.object({
    ...
    NumberOfKidsYouCanHandel : yup.number()
                                .required()
                                .test("is-numkids->0", "you must atleast be able to deal with one kid", (val) => {
            ...
            <Formik
                ...
                onSubmit = { (values) => {
                    ...
                    <View>
                        ...
                        <Text> { props.touched.PhoneNumber && props.errors.PhoneNumber } </Text>
                        ...
                        value = { props.touched.NumberOfKidsYouCanHandel && props.values.NumberOfKidsYouCanHandel}
                        onBlur = {props.handleBlur('NumberOfKidsYouCanHandel')} >
                        </TextInput>
                        {/* Handling test for numberOfKids */}
                        <Text>  { props.touched.NumberOfKidsYouCanHandel && props.errors.NumberOfKidsYouCanHandel }</Text>
                        ...
                        <Text> { props.touched.EducationLevel && props.errors.EducationLevel } </Text>
                        ...
                        <Text> { props.touched.HowMannyHoursYouCanWorkADay && props.errors.HowMannyHoursYouCanWorkADay } </Text>
                        ...
                        <Text> { props.touched.ExperensLevel && props.errors.ExperensLevel } </Text>
    
                        {/* submit bttn  */}
                            <Button title = 'Submit' mode="contained"   onPress = { props.handleSubmit} />
                    </View>
                    ) }
            </Formik>
